...
import { getShippingPolicy } from '../../services/info.service';
import './Shipping.css';
...
const DEFAULT_CONTENT = (
  <>
    ...
    <div className="shipping-article">
      ...
      <p>Thời gian giao hàng phụ thuộc vào địa điểm nhận hàng:</p>
      <ul>
    ...
    <div className="shipping-article">
      ...
      <p>Nếu hàng đến bị hỏng hoặc bị mất trong quá trình vận chuyển:</p>
      <ul>
    ...
    <div className="shipping-article">
      ...
      <p>Với các vật liệu xây dựng chiều dài (sắt, gỗ...) hoặc quá cồng kềnh:</p>
      <ul>
    ...
    <div className="shipping-article">
      ...
      <p>SmartBuild không chịu trách nhiệm về:</p>
      <ul>
        ...
        <div className="container">
          <div className="shipping-content">
            {loading ? (
              ...
              <div className="shipping-article" dangerouslySetInnerHTML={{ __html: content }} />
            ) : (
              DEFAULT_CONTENT
            )}
          </div>
